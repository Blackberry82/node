const {statusCode, emailActionEnum, tokenTypeEnum, constant} = require('../constants');
...
module.exports = {
  ...
  setNewPasswordForgot: async (req, res, next) => {
    try {
      ...
      await previousPassService.savePasswordInfo({password: user.password, user: user._id});
